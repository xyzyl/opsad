...
<div class="header">
  ...
  <span class="sub">interactive anomaly detection &mdash; static demo</span>
</div>
<div class="row">
  <div class="card sidebar">
    ...
    <div class="note">This is a static export: detection scores are precomputed,
      and the threshold, table, and interpretation update live in your browser.
      Live detector <em>re-fitting</em> (changing contamination, window size&hellip;)
      needs the local app: <code>pip install sigmaflow[dashboard]</code> then
      <code>sigmaflow dashboard</code>.</div>
  </div>
  <div class="main">
